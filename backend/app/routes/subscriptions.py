...
async def get_my_subscriptions(
    ...
    service = SubscriptionService(db)
    subscriptions = await service.get_user_subscriptions(str(current_user.id))
...
async def get_subscription(
    ...
    service = SubscriptionService(db)
    subscription = await service.get_subscription(subscription_id, str(current_user.id))
    return subscription
...
async def pause_subscription(
    ...
    service = SubscriptionService(db)
    subscription = await service.pause_subscription(subscription_id, str(current_user.id))
    return subscription
...
async def resume_subscription(
    ...
    service = SubscriptionService(db)
    subscription = await service.resume_subscription(subscription_id, str(current_user.id))
    return subscription
...
async def cancel_subscription(
    ...
    service = SubscriptionService(db)
    subscription = await service.cancel_subscription(subscription_id, str(current_user.id))
    return subscription
